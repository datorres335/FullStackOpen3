    ...
    <div>
      ...
      <form onSubmit={addDiary}>
        ...
        <div>
          ...
          {visibilities.map(v => 
            <span key={v}>
              {v} <input checked={v===visibility} type="radio" name="visibility" onChange={() => setVisibility(v)} />
            </span>
          )}
        </div>
        <div>
          ...
          {weathers.map(w => 
            <span key={w}>
              {w} <input checked={w===weather} type="radio" name="weather" onChange={() => setWeather(w)} />
            </span>
          )}
        </div>
        <div>
